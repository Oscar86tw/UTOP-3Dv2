...
function renderPlanSceneGeometry(){
 ...
 const bounds=getSceneWorldBounds?.()||{
  minX:-10,maxX:10,minZ:-15,maxZ:15
 };
...
function rebuildPlanModelAsTrueTopView(model,item,planRotation){
 // V4.4.0.1：停用通用矩形／橢圓重畫，恢復V4.0.2原圖。
 return null;
 /*
...
if(i.type==='barrier'){
  ...
  // V4.4.0：完成每個2D設備後，固定掛入plan root。
...
/* V4.4.0.1 Collapsible Sidebar Inspector */
(function(){
...
/* V4.4.0.1 Unlimited Loop Dimensions */
(function(){
...
/* V4.4.0.1 Realistic Rendering Foundation */
(async function(){
...
/* =========================================================
   V4.4.0.1 Reliable Scene Brightness
   ========================================================= */
(function(){
...
/* =========================================================
   V4.4.0.1 Mobile Workspace Helpers
   ========================================================= */
...
/* =========================================================
   V4.4.0.1 Professional 2D Selection Engine
   ========================================================= */
(function(){
...
/* V4.4.0.1: map unlabeled SVG groups to the nearest device label/item. */
(function(){
...
/* =========================================================
   V4.4.0.1 Stable Scene Plugin Host API
   ========================================================= */
...
/* =========================================================
   V4.4.0.1 Monte Carlo Scene UI Bridge
   ========================================================= */
(function(){
