...
shutter:{name:'鐵捲門',assetId:'ACCESS-SHUTTER-001',defaults:{rotation:0,state:'CLOSED',showLabel:true},di:[['DI1','OPEN_CMD｜開啟命令','open'],['DI2','STOP_CMD｜停止命令','stop'],['DI3','CLOSE_CMD｜關閉命令','close'],['DI4','SAFETY｜安全訊號','safety'],['DI5','RESET｜復歸','reset']],do:[['DO1','OPEN_LIMIT｜全開到位','openLimit'],['DO2','CLOSE_LIMIT｜全關到位','closeLimit'],['DO3','RUNNING｜運轉中','running'],['DO4','FAULT｜故障','fault']]},
...
/* V3.1.0 Collapsible Sidebar Inspector */
(function(){
...
/* V3.1.0 Unlimited Loop Dimensions */
(function(){
...
/* V3.1.0 Realistic Rendering Foundation */
(async function(){
...
/* =========================================================
   V3.1.0 Reliable Scene Brightness
   ========================================================= */
(function(){
...
/* =========================================================
   V3.1.0 Mobile Workspace Helpers
   ========================================================= */
...
/* =========================================================
   V3.1.0 Professional 2D Selection Engine
   ========================================================= */
(function(){
...
/* V3.1.0: map unlabeled SVG groups to the nearest device label/item. */
(function(){
