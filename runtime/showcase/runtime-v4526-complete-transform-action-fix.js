...
function select(id){
 try{commitSelectedMeshTransform({source:'before-select-change',render:false});}catch(_){}
 state.selectedId=id;
 refreshNameLabels();
 renderAll();
 const item=get(id);
...
function rebuildPlanModelAsTrueTopView(model,item,planRotation){
 // V4.5.2.6.1.1.1：停用通用矩形／橢圓重畫，恢復V4.0.2原圖。
 return null;
 /*
...
function renderPlan(){
 ...
 for(const i of state.items){
  ...
  // V4.5.2.6.1.1.1：恢復 V4.0.2 原始專屬2D模組圖案。
  // 圖案外觀不再由通用矩形／圓形覆蓋。
if(i.type==='barrier'){
  ...
  // V4.5.2.6.1.1.1：保留 V4.0.2 各設備原始圖案。
  // 只做等比例 contain 縮放，不重畫、不拉寬、不壓扁。
  model.dataset.trueTopView='false';
  // V4.5.2.6.1.1：先把設備圖案正式加入outer。
...
const WORLD_ENGINE_VERSION='4.5.2.6';
...
/* V4.5.2.6.1.1.1 Collapsible Sidebar Inspector */
(function(){
...
/* V4.5.2.6.1.1.1 Unlimited Loop Dimensions */
(function(){
...
/* V4.5.2.6.1.1.1 Realistic Rendering Foundation */
(async function(){
...
/* =========================================================
   V4.5.2.6.1.1.1 Reliable Scene Brightness
   ========================================================= */
(function(){
...
/* =========================================================
   V4.5.2.6.1.1.1 Mobile Workspace Helpers
   ========================================================= */
...
/* =========================================================
   V4.5.2.6.1.1.1 Professional 2D Selection Engine
   ========================================================= */
(function(){
...
/* V4.5.2.6.1.1.1: map unlabeled SVG groups to the nearest device label/item. */
(function(){
...
/* =========================================================
   V4.5.2.6.1.1.1 Stable Scene Plugin Host API
   ========================================================= */
...
/* =========================================================
   V4.5.2.6.1.1.1 Monte Carlo Scene UI Bridge
   ========================================================= */
(function(){
