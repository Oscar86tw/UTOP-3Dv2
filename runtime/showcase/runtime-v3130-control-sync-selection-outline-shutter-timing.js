...
function controlRollingShutter(item,key){
 ...
 if(key==='open'){
  ...
  else cancelShutterAutoClose(item);
 }else if(key==='reset'){
  cancelShutterAutoClose(item);
  cancelShutterMotion(item);
  p.fault=false;
...
/* V3.1.3 Collapsible Sidebar Inspector */
(function(){
...
/* V3.1.3 Unlimited Loop Dimensions */
(function(){
...
/* V3.1.3 Realistic Rendering Foundation */
(async function(){
...
/* =========================================================
   V3.1.3 Reliable Scene Brightness
   ========================================================= */
(function(){
...
/* =========================================================
   V3.1.3 Mobile Workspace Helpers
   ========================================================= */
...
/* =========================================================
   V3.1.3 Professional 2D Selection Engine
   ========================================================= */
(function(){
...
/* V3.1.3: map unlabeled SVG groups to the nearest device label/item. */
(function(){
