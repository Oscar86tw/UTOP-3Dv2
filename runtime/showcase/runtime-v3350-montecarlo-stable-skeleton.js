...
$('applySelectedScene')?.addEventListener('click',async()=>{
 ...
 if(chosen==='montecarlo'){
  ...
  try{await window.UTOP_MONTECARLO_PLUGIN?.activate?.();currentManagedSceneId='montecarlo'}
  catch(error){console.error(error);currentManagedSceneId='basic-lane';$('statusText').textContent=`蒙地卡羅載入失敗：${error.message}`;return}
 }else{
  applyScene(chosen);currentManagedSceneId=chosen;
 }
...
/* V3.3.5 Collapsible Sidebar Inspector */
(function(){
...
/* V3.3.5 Unlimited Loop Dimensions */
(function(){
...
/* V3.3.5 Realistic Rendering Foundation */
(async function(){
...
/* =========================================================
   V3.3.5 Reliable Scene Brightness
   ========================================================= */
(function(){
...
/* =========================================================
   V3.3.5 Mobile Workspace Helpers
   ========================================================= */
...
/* =========================================================
   V3.3.5 Professional 2D Selection Engine
   ========================================================= */
(function(){
...
/* V3.3.5: map unlabeled SVG groups to the nearest device label/item. */
(function(){
...
/* =========================================================
   V3.3.5 Stable Scene Plugin Host API
   ========================================================= */
...
/* =========================================================
   V3.3.5 Monte Carlo Scene UI Bridge
   ========================================================= */
(function(){
