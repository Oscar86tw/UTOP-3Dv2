...
// V5.0.0 Alpha 1.1.1.1：記錄基礎場景靜態物件。
...
function makeModel(item){
 ...
 if(item.type==='barrier'){
   ...
   // V5.0.0 Alpha 1.1.1.1：柵欄機只增加垂直高度30%。
   g.scale.y=1.30;
...
function rebuildPlanModelAsTrueTopView(model,item,planRotation){
 // V5.0.0 Alpha 1.1.1.1：停用通用矩形／橢圓重畫，恢復V4.0.2原圖。
 return null;
 /*
...
function syncPlanModelScale(model,item,planRotation){
 ...
 // V5.0.0 Alpha 1.1.1.1：2D圖形禁止X、Y分別拉伸。
...
function renderPlan(){
 ...
 for(const i of state.items){
  ...
  // V5.0.0 Alpha 1.1.1.1：恢復 V4.0.2 原始專屬2D模組圖案。
  // 圖案外觀不再由通用矩形／圓形覆蓋。
if(i.type==='barrier'){
  ...
  // V5.0.0 Alpha 1.1.1.1：保留 V4.0.2 各設備原始圖案。
  // 只做等比例 contain 縮放，不重畫、不拉寬、不壓扁。
  model.dataset.trueTopView='false';
  // V5.0.0 Alpha 1.1.1：先把設備圖案正式加入outer。
  ...
  // V5.0.0 Alpha 1：2D設備名稱與3D共用名稱資料。
...
const WORLD_ENGINE_VERSION='5.0.0-alpha1';
...
/* =========================================================
   V5.0.0 Alpha 1.1.1.1 3D Wiring View
   ========================================================= */
const wiring3DState={
 mode:'2d',
 canvasHome:null,
...
/* V5.0.0 Alpha 1.1.1.1 Collapsible Sidebar Inspector */
(function(){
...
/* V5.0.0 Alpha 1.1.1.1 Unlimited Loop Dimensions */
(function(){
...
/* V5.0.0 Alpha 1.1.1.1 Realistic Rendering Foundation */
(async function(){
...
/* =========================================================
   V5.0.0 Alpha 1.1.1.1 Reliable Scene Brightness
   ========================================================= */
(function(){
...
/* =========================================================
   V5.0.0 Alpha 1.1.1.1 Mobile Workspace Helpers
   ========================================================= */
...
/* =========================================================
   V5.0.0 Alpha 1.1.1.1 Professional 2D Selection Engine
   ========================================================= */
(function(){
...
/* V5.0.0 Alpha 1.1.1.1: map unlabeled SVG groups to the nearest device label/item. */
(function(){
...
/* =========================================================
   V5.0.0 Alpha 1.1.1.1 Stable Scene Plugin Host API
   ========================================================= */
...
/* =========================================================
   V5.0.0 Alpha 1.1.1.1 Monte Carlo Scene UI Bridge
   ========================================================= */
(function(){
