...
function rebuildPlanModelAsTrueTopView(model,item,planRotation){
 // V4.3.9.3.1：停用通用矩形／橢圓重畫，恢復V4.0.2原圖。
 return null;
 /*
...
function renderPlan(){
 ...
 for(const i of state.items){
  ...
  // V4.3.9.3.1：恢復 V4.0.2 原始專屬2D模組圖案。
  // 圖案外觀不再由通用矩形／圓形覆蓋。
if(i.type==='barrier'){
    const sign=p.armSide==='right'?1:-1;
...
/* V4.3.9.3.1 Collapsible Sidebar Inspector */
(function(){
...
/* V4.3.9.3.1 Unlimited Loop Dimensions */
(function(){
...
/* V4.3.9.3.1 Realistic Rendering Foundation */
(async function(){
...
/* =========================================================
   V4.3.9.3.1 Reliable Scene Brightness
   ========================================================= */
(function(){
...
/* =========================================================
   V4.3.9.3.1 Mobile Workspace Helpers
   ========================================================= */
...
/* =========================================================
   V4.3.9.3.1 Professional 2D Selection Engine
   ========================================================= */
(function(){
...
/* V4.3.9.3.1: map unlabeled SVG groups to the nearest device label/item. */
(function(){
...
/* =========================================================
   V4.3.9.3.1 Stable Scene Plugin Host API
   ========================================================= */
...
/* =========================================================
   V4.3.9.3.1 Monte Carlo Scene UI Bridge
   ========================================================= */
(function(){
