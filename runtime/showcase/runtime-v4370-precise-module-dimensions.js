...
function getDimensionAuditReport(){
 ...
 const missing=state.items
  .filter(item=>!item?.mesh?.userData?.realDimensions)
  .map(item=>({
   id:item.id,
   type:item.type,
   name:item.name,
...
/* V4.3.7 Collapsible Sidebar Inspector */
(function(){
...
/* V4.3.7 Unlimited Loop Dimensions */
(function(){
...
/* V4.3.7 Realistic Rendering Foundation */
(async function(){
...
/* =========================================================
   V4.3.7 Reliable Scene Brightness
   ========================================================= */
(function(){
...
/* =========================================================
   V4.3.7 Mobile Workspace Helpers
   ========================================================= */
...
/* =========================================================
   V4.3.7 Professional 2D Selection Engine
   ========================================================= */
(function(){
...
/* V4.3.7: map unlabeled SVG groups to the nearest device label/item. */
(function(){
...
/* =========================================================
   V4.3.7 Stable Scene Plugin Host API
   ========================================================= */
...
/* =========================================================
   V4.3.7 Monte Carlo Scene UI Bridge
   ========================================================= */
(function(){
