...
/* V2.7.1 Sidebar Panel Fix */
(function(){
 function repairSidebarPanels(){
  const list=document.getElementById('moduleList');
  const content=document.getElementById('moduleLibraryContent');
  ...
  // Inspector must remain inside the left sidebar.
  const shell=document.getElementById('deviceInspectorShell');
 ...
 setTimeout(repairSidebarPanels,0);
 window.addEventListener('utop:runtime-ready',repairSidebarPanels);
})();
