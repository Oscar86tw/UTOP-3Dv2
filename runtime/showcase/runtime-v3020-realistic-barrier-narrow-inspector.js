 ...
 for(const i of state.items){
  ...
  if(i.type==='barrier'){
    ...
    for(let distance=24;distance<projectedLength;distance+=38){
      ...
      stripe.setAttribute('width',(projectedLength-distance));
...
/* V3.0.2 Collapsible Sidebar Inspector */
(function(){
...
/* V3.0.2 Unlimited Loop Dimensions */
(function(){
...
/* V3.0.2 Realistic Rendering Foundation */
(async function(){
