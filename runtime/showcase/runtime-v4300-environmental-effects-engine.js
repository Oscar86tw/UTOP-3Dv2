...
function syncPlanModelScale(model,item,planRotation){
 ...
 const scaleX=desiredWidth/intrinsicWidth;
 const scaleY=desiredHeight/intrinsicHeight;

 model.setAttribute(
  'transform',
  `rotate(${planRotation}) scale(${scaleX} ${scaleY})`
 );

 model.dataset.worldWidth=footprint.width.toFixed(3);
 model.dataset.worldDepth=footprint.depth.toFixed(3);
 model.dataset.planWidth=desiredWidth.toFixed(2);
 model.dataset.planHeight=desiredHeight.toFixed(2);
 model.dataset.planScaleX=scaleX.toFixed(4);
 model.dataset.planScaleY=scaleY.toFixed(4);
...
/* V4.3.0 Collapsible Sidebar Inspector */
(function(){
...
/* V4.3.0 Unlimited Loop Dimensions */
(function(){
...
/* V4.3.0 Realistic Rendering Foundation */
(async function(){
...
/* =========================================================
   V4.3.0 Reliable Scene Brightness
   ========================================================= */
(function(){
...
/* =========================================================
   V4.3.0 Mobile Workspace Helpers
   ========================================================= */
...
/* =========================================================
   V4.3.0 Professional 2D Selection Engine
   ========================================================= */
(function(){
...
/* V4.3.0: map unlabeled SVG groups to the nearest device label/item. */
(function(){
...
/* =========================================================
   V4.3.0 Stable Scene Plugin Host API
   ========================================================= */
...
/* =========================================================
   V4.3.0 Monte Carlo Scene UI Bridge
   ========================================================= */
(function(){
