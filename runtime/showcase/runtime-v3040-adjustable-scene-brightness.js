...
/* V3.0.4 Collapsible Sidebar Inspector */
(function(){
...
/* V3.0.4 Unlimited Loop Dimensions */
(function(){
...
/* V3.0.4 Realistic Rendering Foundation */
(async function(){
...
/* =========================================================
   V3.0.4 Adjustable Scene Brightness
   ========================================================= */
(function(){
 ...
 function applySceneBrightness(){
  const multiplier=Math.max(.6,Math.min(1.8,brightnessMultiplier));

  // Exposure carries most of the visual change while light changes preserve
  // material readability and shadow depth.
 ...
 window.addEventListener('utop-scene-brightness-change',event=>{
  const next=Number(event.detail?.multiplier);
  if(Number.isFinite(next)){
   brightnessMultiplier=next;
